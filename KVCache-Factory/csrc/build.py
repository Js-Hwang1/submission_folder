...
cc_flag.append("arch=compute_80,code=sm_80")  # A100
cc_flag.append("-gencode")
cc_flag.append("arch=compute_86,code=sm_86")  # RTX 3090
cc_flag.append("-gencode")
cc_flag.append("arch=compute_89,code=sm_89")  # RTX 4090
cc_flag.append("-gencode")
cc_flag.append("arch=compute_90,code=sm_90")  # H100
