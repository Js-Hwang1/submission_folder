...
from pyramidkv.pyramidkv_utils import init_pyramidkv,init_snapkv,init_CAM,init_H2O,init_StreamingLLM,init_l2norm, init_adakv, init_headkv, init_circuitkv, init_maxkv
import math
...
# CircuitKV: Current-Flow Betweenness for KV Cache Eviction
# ============================================================================

def llama_flash_attn2_forward_CircuitKV(
    self,
    hidden_states: torch.Tensor,
    attention_mask: Optional[torch.LongTensor] = None,
    position_ids: Optional[torch.LongTensor] = None,
...
def llama_attn_forward_CircuitKV(
    self,
    hidden_states: torch.Tensor,
    attention_mask: Optional[torch.Tensor] = None,
    position_ids: Optional[torch.LongTensor] = None,
...
def llama_sdpa_attn_forward_CircuitKV(
    self,
    hidden_states: torch.Tensor,
    attention_mask: Optional[torch.Tensor] = None,
    position_ids: Optional[torch.LongTensor] = None,
    ...
    **kwargs,
    ...
    if output_attentions:
        ...
        return llama_attn_forward_CircuitKV(
            self,
            hidden_states=hidden_states,
            attention_mask=attention_mask,
            position_ids=position_ids,
...
# ============================================================================
# MAXKV FORWARD FUNCTIONS - MAX(H2O, Influence) with Rank Normalization
# ============================================================================

def llama_flash_attn2_forward_MaxKV(
    self,
    hidden_states: torch.Tensor,
    attention_mask: Optional[torch.LongTensor] = None,
    position_ids: Optional[torch.LongTensor] = None,
...
def llama_sdpa_attn_forward_MaxKV(
    self,
    hidden_states: torch.Tensor,
    attention_mask: Optional[torch.Tensor] = None,
    position_ids: Optional[torch.LongTensor] = None,
    ...
    **kwargs,
    ...
    if output_attentions:
        ...
        return llama_attn_forward_MaxKV(
            self, hidden_states=hidden_states, attention_mask=attention_mask, position_ids=position_ids,
