"""
Qwen2 model attention forward implementations for KV-Cache eviction methods.
Supports: H2O, SnapKV, PyramidKV, StreamingLLM, CircuitKV, and others.
...
# =============================================================================
# H2O (Heavy-Hitter Oracle) Attention Forwards
# =============================================================================
...
def qwen2_attn_forward_H2O(
    ...
    **kwargs,
    ...
    # Handle rotary embeddings - Qwen2's rotary_emb returns already-indexed cos/sin
    # and apply_rotary_pos_emb does NOT accept position_ids
    if position_embeddings is not None:
        cos, sin = position_embeddings
    else:
        # Qwen2's rotary_emb(x, position_ids) returns cos/sin already indexed by position_ids
        cos, sin = self.rotary_emb(value_states, position_ids)
    # Qwen2's apply_rotary_pos_emb signature: (q, k, cos, sin, unsqueeze_dim=1) - NO position_ids
...
def qwen2_sdpa_attn_forward_SnapKV(
    ...
    **kwargs,
    ...
    if output_attentions:
        return qwen2_attn_forward_SnapKV(
            self,
            hidden_states=hidden_states,
            attention_mask=attention_mask,
            position_ids=position_ids,
...
def qwen2_sdpa_attn_forward_PyramidKV(
    ...
    **kwargs,
    ...
    if output_attentions:
        return qwen2_attn_forward_PyramidKV(
            self,
            hidden_states=hidden_states,
            attention_mask=attention_mask,
            position_ids=position_ids,
...
# =============================================================================
# StreamingLLM Attention Forwards
# =============================================================================
...
def qwen2_sdpa_attn_forward_StreamingLLM(
    self,
    hidden_states: torch.Tensor,
    attention_mask: Optional[torch.Tensor] = None,
    position_ids: Optional[torch.LongTensor] = None,
    ...
    **kwargs,
    ...
    if output_attentions:
        return qwen2_attn_forward_StreamingLLM(
            self,
            hidden_states=hidden_states,
            attention_mask=attention_mask,
            position_ids=position_ids,
...
# =============================================================================
# CircuitKV Attention Forwards (Current-Flow Betweenness)
# =============================================================================

def qwen2_attn_forward_CircuitKV(
    self,
    hidden_states: torch.Tensor,
    attention_mask: Optional[torch.Tensor] = None,
    position_ids: Optional[torch.LongTensor] = None,
...
def qwen2_sdpa_attn_forward_CircuitKV(
    self,
    hidden_states: torch.Tensor,
    attention_mask: Optional[torch.Tensor] = None,
    position_ids: Optional[torch.LongTensor] = None,
    ...
    **kwargs,
    ...
    if output_attentions:
        return qwen2_attn_forward_CircuitKV(
            self,
            hidden_states=hidden_states,
            attention_mask=attention_mask,
            position_ids=position_ids,
...
def qwen2_flash_attn2_forward_CircuitKV(
    self,
    hidden_states: torch.Tensor,
    attention_mask: Optional[torch.LongTensor] = None,
    position_ids: Optional[torch.LongTensor] = None,
